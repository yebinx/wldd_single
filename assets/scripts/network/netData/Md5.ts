...
class MD5 {
    private static hexcase: number = 0;  // 0 - lowercase; 1 - uppercase
    private static b64pad: string = "";  // base-64 pad character. "=" for strict RFC compliance
    private static chrsz: number = 8;    // 8 - ASCII; 16 - Unicode

    public static hex_md5(s: string): string {
        return this.binl2hex(this.core_md5(this.str2binl(s), s.length * this.chrsz));
    }

    public static b64_md5(s: string): string {
        return this.binl2b64(this.core_md5(this.str2binl(s), s.length * this.chrsz));
    }

    public static str_md5(s: string): string {
    ...
    public static str_hmac_md5(key: string, data: string): string {
        return this.binl2str(this.core_hmac_md5(key, data));
    }

    private static core_md5(x: WordArray, len: number): WordArray {
        /* append padding */
        x[len >> 5] |= 0x80 << ((len) % 32);
        x[(((len + 64) >>> 9) << 4) + 14] = len;
    ...
    private static md5_cmn(q: number, a: number, b: number, x: number, s: number, t: number): number {
    ...
    private static core_hmac_md5(key: string, data: string): WordArray {
    ...
    private static str2binl(str: string): WordArray {
        var bin = Array();
        var mask = (1 << chrsz) - 1;
    ...
    private static binl2str(bin: WordArray): string {
        var str = "";
        var mask = (1 << chrsz) - 1;
    ...
    private static binl2hex(binarray: WordArray): string {
    ...
    private static binl2b64(binarray: WordArray): string {
    ...
    */
    private static rstr_md5(s) {
        return this.binl2rstr(this.core_md5(this.rstr2binl(s), s.length * 8));
    }
